...
symptom1 = seriousSymptomsInput()
symptom2 = mostCommonSymptomsInput()

symptomaticResult = "negative"
# checking symptom1
# If one symptom occur then there is high possiblity of covid 19
if symptom1[0] or symptom1[1] or symptom1[2] :
    symptomaticResult = "positive"
elif symptom2[0] and symptom2[1] and symptom2[2] and symptom2[3]:
    symptomaticResult = "positive"
